...
import { TrailerInfo } from "src/app/model/entities/trailer-info";
import { CompanyService } from "src/app/services/company.service";
import { TrailerPageRequest } from "../contracts/requests/trailer-page-request";

export class TrailerForVehicleDataSource extends DataSource<TrailerInfo> {
    ...
    loadTrailers(request: TrailerPageRequest = new TrailerPageRequest(), vehicleId: number) {
        this.loadingSubject.next(true);
        this.companyService.getTrailersForVehicle(request, vehicleId).subscribe({
            next: (response) => {
